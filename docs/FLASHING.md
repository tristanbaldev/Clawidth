...
Two parts: (1) put **MicroPython** on the board once, (2) copy the Clawidth files
...
**3. Upload Clawidth** (run from the repo root):
...
1. On your phone, join wifi **`Clawidth`** (password `payday123`).
